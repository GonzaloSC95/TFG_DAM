...
public abstract class PlayerStates
{
    ...
    public virtual void Tick()
    {
        ...
        //Cambio para controles en dispositivos mobiles
        float movementAmount = CrossPlatformInputManager.GetAxis("Horizontal");
...
public class PlayerJumping : PlayerStates
{
    ...
    public override void FixedTick()
    {
        ...
        base.FixedTick();
        //Cambio para controles en dispositivos mobiles
        float movementAmount = Mathf.Clamp(CrossPlatformInputManager.GetAxis("Horizontal") * 20f, int.MinValue, 0);
...
public class PlayerGrounded : PlayerStates
{
    ...
    public override void Tick()
    {
        ...
        //Cambio para controles en dispositivos mobiles
        if ((CrossPlatformInputManager.GetAxis("Horizontal") != 0) || CrossPlatformInputManager.GetButtonDown("Jump"))
        {
            ProcessInput(movementAmount);
        } 
    }
